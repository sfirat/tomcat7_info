#!/bin/bash
wget -c -q "http://apache.volia.net/tomcat/tomcat-7/v7.0.88/bin/extras/tomcat-juli-adapters.jar" -O /opt/tomcat-juli-adapters.jar
wget -c -q "http://apache.volia.net/tomcat/tomcat-7/v7.0.88/bin/extras/tomcat-juli.jar" -O /opt/tomcat-juli.jar
